...
Shader "Tekcast/Prefab/Training Counter"
{
	Properties
	{
		...
		_CoarseTrainingEffectScale( "Coarse Training Effect Scale", Range( 0, 10 ) ) = 5.659362
		_FineTrainingEffectScale( "Fine Training Effect Scale", Range( 0, 10 ) ) = 0
		_RecoveryHoursScale( "Recovery Hours Scale", Range( 0, 10 ) ) = 0
		_CoarseTrainingEffectOffset( "Coarse Training Effect Offset", Vector ) = ( 0, 0, 0, 0 )
		_FineTrainingEffectOffset( "Fine Training Effect Offset", Vector ) = ( 0, 0, 0, 0 )
		_RecoveryHoursOffset( "Recovery Hours Offset", Vector ) = ( 0, 0, 0, 0 )
		_CoarseTrainingEffect( "Coarse Training Effect", Vector ) = ( 7, 7, 7, 7 )
		_FineTrainingEffect( "Fine Training Effect", Vector ) = ( 0, 0, 0, 0 )
	...
	SubShader
	{
		...
		uniform float _CoarseTrainingEffectScale;
		uniform float2 _CoarseTrainingEffectOffset;
		uniform float4 _CoarseTrainingEffect;
		SamplerState sampler_Font;
		uniform float _FineTrainingEffectScale;
		uniform float2 _FineTrainingEffectOffset;
		uniform float4 _FineTrainingEffect;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult129_g1207 = (float2(1.0 , 1.0));
			float Counter_1_Scale754 = _CoarseTrainingEffectScale;
			float clampResult236_g1207 = clamp( Counter_1_Scale754 , 1.0 , 10.0 );
			float temp_output_114_0_g1207 =  (1.0 + ( clampResult236_g1207 - 1.0 ) * ( 20.0 - 1.0 ) / ( 10.0 - 1.0 ) );
			float2 appendResult131_g1207 = (float2(0.0 , 0.0));
			float temp_output_127_0_g1207 = ( ( 1.0 - temp_output_114_0_g1207 ) * 0.5 );
			float2 appendResult130_g1207 = (float2(temp_output_127_0_g1207 , temp_output_127_0_g1207));
			float2 Counter_1_Offset753 = _CoarseTrainingEffectOffset;
			...
			float4 Counter_1_Digits737 = _CoarseTrainingEffect;
			...
			float4 temp_output_2_0_g1210 = color146_g1207;
			float4 temp_output_2_0_g1209 = color146_g1207;
			...
			float2 appendResult129_g1284 = (float2(1.0 , 1.0));
			float Counter_2_Scale779 = _FineTrainingEffectScale;
			float clampResult236_g1284 = clamp( Counter_2_Scale779 , 1.0 , 10.0 );
			float temp_output_114_0_g1284 =  (1.0 + ( clampResult236_g1284 - 1.0 ) * ( 20.0 - 1.0 ) / ( 10.0 - 1.0 ) );
			float2 appendResult131_g1284 = (float2(0.0 , 0.0));
			float temp_output_127_0_g1284 = ( ( 1.0 - temp_output_114_0_g1284 ) * 0.5 );
			float2 appendResult130_g1284 = (float2(temp_output_127_0_g1284 , temp_output_127_0_g1284));
			float2 Counter_2_Offset780 = _FineTrainingEffectOffset;
			...
			float4 Counter_2_Digits778 = _FineTrainingEffect;
			...
			float4 temp_output_2_0_g1287 = color146_g1284;
			float4 temp_output_2_0_g1286 = color146_g1284;
			...
			float4 temp_output_2_0_g1215 = color271_g1207;
			float4 temp_output_2_0_g1214 = color271_g1207;
			...
			float4 temp_output_2_0_g1292 = color271_g1284;
			float4 temp_output_2_0_g1291 = color271_g1284;
...
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;586;-1776,-1616;Inherit;False;Property;_CoarseTrainingEffect;Coarse Training Effect;14;0;Create;True;1;Counter Digit Values;0;0;False;0;False;7,7,7,7;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;538;-1776,-1440;Inherit;False;Property;_CoarseTrainingEffectScale;Coarse Training Effect Scale;6;0;Create;True;1;Counter Scales;0;0;False;0;False;5.659362;7;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;537;-1776,-1344;Inherit;False;Property;_CoarseTrainingEffectOffset;Coarse Training Effect Offset;10;0;Create;True;1;Counter Offsets;0;0;False;0;False;0,0;0,-2.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;592;-1744,-1024;Inherit;False;Property;_FineTrainingEffect;Fine Training Effect;15;0;Create;True;1;Counter Digit Values;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;547;-1744,-848;Inherit;False;Property;_FineTrainingEffectScale;Fine Training Effect Scale;7;0;Create;True;0;0;0;False;0;False;0;7;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;548;-1744,-768;Inherit;False;Property;_FineTrainingEffectOffset;Fine Training Effect Offset;11;0;Create;True;0;0;0;False;0;False;0,0;4.5,0.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;593;-1744,-416;Inherit;False;Property;_RecoveryHours;Recovery Hours;16;0;Create;True;1;Counter Digit Values;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;561;-1744,-240;Inherit;False;Property;_RecoveryHoursScale;Recovery Hours Scale;8;0;Create;True;0;0;0;False;0;False;0;7;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;562;-1744,-160;Inherit;False;Property;_RecoveryHoursOffset;Recovery Hours Offset;12;0;Create;True;0;0;0;False;0;False;0,0;-4.5,0.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;756;-320,-1504;Inherit;False;Create Number;-1;;1207;36bba83cc54e07e449728c7a7faa3517;10,166,0,167,0,222,0,223,0,224,0,225,0,221,0,270,0,273,0,272,0;4;163;SAMPLER2DARRAY;0;False;241;FLOAT4;0,0,0,0;False;235;FLOAT;0;False;234;FLOAT2;0,0;False;3;FLOAT;269;FLOAT3;0;FLOAT;162
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;788;-352,-720;Inherit;False;Create Number;-1;;1284;36bba83cc54e07e449728c7a7faa3517;10,166,0,167,0,222,0,223,0,224,0,225,0,221,0,270,0,273,0,272,0;4;163;SAMPLER2DARRAY;0;False;241;FLOAT4;0,0,0,0;False;235;FLOAT;0;False;234;FLOAT2;0,0;False;3;FLOAT;269;FLOAT3;0;FLOAT;162
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;833;-352,32;Inherit;False;Create Number;-1;;1372;36bba83cc54e07e449728c7a7faa3517;10,166,1,167,1,222,1,223,1,224,1,225,1,221,1,270,1,273,1,272,1;4;163;SAMPLER2DARRAY;0;False;241;FLOAT4;0,0,0,0;False;235;FLOAT;0;False;234;FLOAT2;0,0;False;3;FLOAT;269;FLOAT3;0;FLOAT;162
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;821;896,-608;Inherit;False;1188;851;;6;771;801;820;727;815;891;Backing Mixing;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;811;896,-1792;Inherit;False;1476;1091;;10;767;798;808;613;566;567;806;872;873;892;Color Mixing;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;872;1632,-1760;Inherit;False;Property;_DigitColor;Digit Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,0,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;864;2688,-688;Inherit;True;Property;_Background;Background;2;0;Create;True;0;0;0;False;0;False;None;6260004ecd035b044a6da30db87ddae9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;877;3216,416;Inherit;True;Property;_AdditionalEmissives;Additional Emissives;4;0;Create;True;0;0;0;False;0;False;None;3f07f625b9fed144f817d8d7c3c3b524;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;594;-1744,192;Inherit;False;Property;_AvgHeartRate;Avg HeartRate;17;0;Create;True;1;Counter Digit Values;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;591;-1744,464;Inherit;False;Property;_AvgHeartRateOffset;Avg HeartRate Offset;13;0;Create;True;0;0;0;False;0;False;0,0;0,0.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;590;-1744,368;Inherit;False;Property;_AvgHeartRateScale;Avg HeartRate Scale;9;0;Create;True;0;0;0;False;0;False;0;7;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;890;4144,-704;Inherit;True;Property;_Normal;Normal;18;1;[Normal];Create;True;0;0;0;False;0;False;None;d896ed67ba7218d4599e6c00000bdac8;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;891;960,-96;Inherit;False;848;Counter 4 Backing Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;892;944,-1104;Inherit;False;847;Counter 4 Color;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;4864,-304;Float;False;True;-1;2;AmplifyShaderEditor.MaterialInspector;0;0;StandardSpecular;Tekcast/Prefab/Training Counter;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;True;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;1;True;False;0;False;Transparent;;Transparent;All;12;all;True;True;True;False;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;False;2;5;False;;10;False;;4;1;False;;1;False;;0;False;;1;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;_Culling;-1;0;False;_Opacity;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=61EA5FF1C6BB007FAB105D7B8304B929377D8BE4