...
Shader "Tekcast/Prefab/Calories Counter"
{
	Properties
	{
		...
		_CaloriesBurntScale( "Calories Burnt Scale", Range( 0, 10 ) ) = 5.659362
		_CoarseBurnRateScale( "Coarse Burn Rate Scale", Range( 0, 10 ) ) = 0
		_FineBurnRateScale( "Fine Burn Rate Scale", Range( 0, 10 ) ) = 0
		_CaloriesBurntOffset( "Calories Burnt Offset", Vector ) = ( 0, 0, 0, 0 )
		_CoarseBurnRateOffset( "Coarse Burn Rate Offset", Vector ) = ( 0, 0, 0, 0 )
		_FineBurnRateOffset( "Fine Burn Rate Offset", Vector ) = ( 0, 0, 0, 0 )
		_CaloriesBurnt( "Calories Burnt", Vector ) = ( 7, 7, 7, 7 )
		_CoarseBurnRate( "Coarse Burn Rate", Vector ) = ( 0, 0, 0, 0 )
		_FineBurnRate( "Fine Burn Rate", Vector ) = ( 0, 0, 0, 0 )
	...
	SubShader
	{
		...
		uniform float _CaloriesBurntScale;
		uniform float2 _CaloriesBurntOffset;
		uniform float4 _CaloriesBurnt;
		SamplerState sampler_Font;
		uniform float _CoarseBurnRateScale;
		uniform float2 _CoarseBurnRateOffset;
		uniform float4 _CoarseBurnRate;
		uniform float _FineBurnRateScale;
		uniform float2 _FineBurnRateOffset;
		uniform float4 _FineBurnRate;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult129_g1207 = (float2(4.0 , 4.0));
			float Counter_1_Scale754 = _CaloriesBurntScale;
			float clampResult236_g1207 = clamp( Counter_1_Scale754 , 1.0 , 10.0 );
			float temp_output_114_0_g1207 =  (1.0 + ( clampResult236_g1207 - 1.0 ) * ( 5.0 - 1.0 ) / ( 10.0 - 1.0 ) );
			float2 appendResult131_g1207 = (float2(0.0 , -1.5));
			float temp_output_127_0_g1207 = ( ( 1.0 - temp_output_114_0_g1207 ) * 2.0 );
			float2 appendResult130_g1207 = (float2(temp_output_127_0_g1207 , temp_output_127_0_g1207));
			float2 Counter_1_Offset753 = _CaloriesBurntOffset;
			...
			float4 Counter_1_Digits737 = _CaloriesBurnt;
			...
			float2 clampResult137_g1207 = clamp( uv_TexCoord135_g1207 , float2( 3,0 ) , float2( 4,1 ) );
			float clampResult233_g1207 = clamp( break260_g1207.w , 0.0 , 9.0 );
			float4 temp_output_2_0_g1211 = SAMPLE_TEXTURE2D_ARRAY( _Font, sampler_Font, float3(clampResult137_g1207,clampResult233_g1207) );
			...
			float Counter_2_Scale779 = _CoarseBurnRateScale;
			...
			float2 Counter_2_Offset780 = _CoarseBurnRateOffset;
			...
			float4 Counter_2_Digits778 = _CoarseBurnRate;
			...
			float Counter_3_Scale829 = _FineBurnRateScale;
			...
			float2 Counter_3_Offset830 = _FineBurnRateOffset;
			...
			float4 Counter_3_Digits828 = _FineBurnRate;
			...
			float4 temp_output_2_0_g1216 = SAMPLE_TEXTURE2D_ARRAY( _Font, sampler_Font, float3(clampResult137_g1207,0.0) );
...
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;586;-1776,-1616;Inherit;False;Property;_CaloriesBurnt;Calories Burnt;14;0;Create;True;1;Counter Digit Values;0;0;False;0;False;7,7,7,7;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;538;-1776,-1440;Inherit;False;Property;_CaloriesBurntScale;Calories Burnt Scale;6;0;Create;True;1;Counter Scales;0;0;False;0;False;5.659362;7;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;537;-1776,-1344;Inherit;False;Property;_CaloriesBurntOffset;Calories Burnt Offset;10;0;Create;True;1;Counter Offsets;0;0;False;0;False;0,0;0,-2.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;592;-1744,-1024;Inherit;False;Property;_CoarseBurnRate;Coarse Burn Rate;15;0;Create;True;1;Counter Digit Values;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;547;-1744,-848;Inherit;False;Property;_CoarseBurnRateScale;Coarse Burn Rate Scale;7;0;Create;True;0;0;0;False;0;False;0;7;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;548;-1744,-768;Inherit;False;Property;_CoarseBurnRateOffset;Coarse Burn Rate Offset;11;0;Create;True;0;0;0;False;0;False;0,0;4.5,0.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;593;-1744,-416;Inherit;False;Property;_FineBurnRate;Fine Burn Rate;16;0;Create;True;1;Counter Digit Values;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;561;-1744,-240;Inherit;False;Property;_FineBurnRateScale;Fine Burn Rate Scale;8;0;Create;True;0;0;0;False;0;False;0;7;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;562;-1744,-160;Inherit;False;Property;_FineBurnRateOffset;Fine Burn Rate Offset;12;0;Create;True;0;0;0;False;0;False;0,0;-4.5,0.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;4864,-304;Float;False;True;-1;2;AmplifyShaderEditor.MaterialInspector;0;0;StandardSpecular;Tekcast/Prefab/Calories Counter;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;True;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;1;True;False;0;False;Transparent;;Transparent;All;12;all;True;True;True;False;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;False;2;5;False;;10;False;;4;1;False;;1;False;;0;False;;1;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;_Culling;-1;0;False;_Opacity;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=FD95DB816B005476E75F39B3AB7B47B11F8B58A3